...
const content_view_component_1 = require("../content-view/content-view.component");
let SideBarComponent = (() => {
    let _classDecorators = [(0, core_1.Component)({
            selector: 'app-side-bar',
            standalone: true,
            imports: [sidenav_1.MatSidenavModule, content_view_component_1.ContentViewComponent],
